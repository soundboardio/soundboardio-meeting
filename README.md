<p align="center">
  ...
  <h1 align="center">SoundBoardio plugin: Zoom meeting survival kit</h1>
</p>
...
1. Create new repository on your Github, based on this repository.
   ...
   - Create your **[`soundboardio.json`](https://github.com/soundboardio/meeting/blob/master/soundboardio.json) manifest**. Be creative. Choose name, description, colors and tiles, ...
   - Prepare **icons** (you will need at least two icons if you want your app to be installable). [See this example](https://github.com/soundboardio/meeting/blob/master/soundboardio.json#L13)
2. Now you can just open your shiny new app with your own url. It's working automagically.

> If your repository is called https://github.com/ `soundboardio/meeting` your SoundBoardio url will be https://soundboardio.com/ `app/soundboardio/meeting`
...
Copyright &copy; 2026 [AquaSoup](http://aquasoup.com)
